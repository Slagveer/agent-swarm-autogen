...
agents_A = [
    ...
    AssistantAgent(
        name="A3",
        system_message="You are team member A3, You know the secret value of y but not x, y = 8. Tell others y to cooperate.",
        llm_config=llm_config,
    ),
]
...
list_of_agents : list[AssistantAgent | UserProxyAgent] = agents_A + agents_B
...
def hello_world():  # put application's code here
    ...
    return agents_B[1].last_message().get('content')
